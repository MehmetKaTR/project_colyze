...
export const sendPolygonsToCalculateRgbi = async ({
  ...
  try {
    ...
    const saveResponse = await fetch("http://localhost:5050/save_txt", {
      method: "POST",
      headers: { "Content-Type": "application/json" },
      body: JSON.stringify({ 
        typeNo, 
    ...
    console.log("Txt kaydedildi:", saveData.filename);
...
export const sendPolygonsToCalculateHistogram = async ({
  ...
  try {
    ...
    const saveRes = await fetch("http://localhost:5050/save_txt", {
      method: "POST",
      headers: { "Content-Type": "application/json" },
      body: JSON.stringify({
        typeNo,
